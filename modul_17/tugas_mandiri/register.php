...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
  ...
  $level = "user"; // default level user, hanya admin yang bisa set admin
  ...
  <div class="login-box">
    ...
    <form method="POST" action="">
      <div class="field">
        ...
        <input type="text" name="username" value="<?= htmlspecialchars($_POST["username"] ?? "") ?>" autofocus placeholder="Minimal 3 karakter" />
      </div>
      <div class="field">
      ...
      <div class="field">
        ...
        <input type="text" value="User (View Only)" readonly style="background:#f3f4f6;color:#6b7280;cursor:not-allowed;" />
      </div>
